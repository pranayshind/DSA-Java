...
//order ignostic mean here conditio is that we dont know the array is sored in which order
public class Order_Ignostic {
	...
	static int binary(int[] arr,int target) {
		...
		//here we have written code both for ascending or descending order sorted array
		while(start<=end) {
